...
del game.lst	REM game可以替換成.asm檔的檔名
del game.obj
del game.ilk
del game.pdb
del game.exe
...
ML /c /coff /Zi   game.asm
ML /c /coff /Zi   _arrow.asm
ML /c /coff /Zi   _blink.asm
ML /c /coff /Zi  _setup.asm
ML /c /coff /Zi  _battle.asm
ML /c /coff /Zi  _boss_skill.asm
ML /c /coff /Zi  _player_skill.asm
ML /c /coff /Zi  _player_cure.asm
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:game.exe game.obj _arrow.obj _blink.obj _setup.obj _battle.obj _boss_skill.obj _player_skill.obj _player_cure.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
